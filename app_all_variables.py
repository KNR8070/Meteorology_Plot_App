...
def plot_wind_rose(speed_pwr, direction_pwr,lat_l,lon_l):
    ...
    ax.set_legend()
    ax.text(0.6,0.05,'Source: '+ds_temp.attrs['source'],fontsize=4)
    st.pyplot()  
#%% [markdown] 
...
def plot_spatial(temp_subset, lat_min, lat_max, lon_min, lon_max):
    ...
    ax3.text(0.6,0.05,'Source: '+ds_temp.attrs['source'],fontsize=4)
    st.pyplot(fig)
#%% [markdown]
##  Spatial plot test
...
def plot_time_series(speed,direction): 
    ...
    ax1.text(0.6,0.05,'Source: '+ds_temp.attrs['source'],fontsize=4)
    st.pyplot(fig)
#%% [markdown]
##  Time Series Plot
